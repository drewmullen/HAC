...
class Body108(object):
    ...
    def ca_file(self, ca_file):
        """Sets the ca_file of this Body108.

        A path to a file containing a PEM-encoded CA certificate to verify the call against the primary's API address  # noqa: E501

        :param ca_file: The ca_file of this Body108.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ca_path(self):
        """Gets the ca_path of this Body108.  # noqa: E501
        ...
        :return: The ca_path of this Body108.  # noqa: E501
        :rtype: str
        """
    ...
    def ca_path(self, ca_path):
        """Sets the ca_path of this Body108.

        A path to a directory containing PEM-encoded CA certificates to verify the call against the primary's API address  # noqa: E501

        :param ca_path: The ca_path of this Body108.  # noqa: E501
        :type: str
        """
    ...
    def client_cert_pem(self):
        """Gets the client_cert_pem of this Body108.  # noqa: E501
        ...
        :return: The client_cert_pem of this Body108.  # noqa: E501
        :rtype: str
        """
    ...
    def client_cert_pem(self, client_cert_pem):
        """Sets the client_cert_pem of this Body108.

        The client certificate to use for authentication, in PEM format. Note: client authentication for this operation will always use TLS 1.2 or higher.  # noqa: E501

        :param client_cert_pem: The client_cert_pem of this Body108.  # noqa: E501
        :type: str
        """
    ...
    def client_key_pem(self):
        """Gets the client_key_pem of this Body108.  # noqa: E501

        The client key to use for authentication, in PEM format.  # noqa: E501

        :return: The client_key_pem of this Body108.  # noqa: E501
        :rtype: str
        """
    ...
    def client_key_pem(self, client_key_pem):
        """Sets the client_key_pem of this Body108.

        The client key to use for authentication, in PEM format.  # noqa: E501

        :param client_key_pem: The client_key_pem of this Body108.  # noqa: E501
        :type: str
        """
    ...
    def primary_api_addr(self):
        """Gets the primary_api_addr of this Body108.  # noqa: E501
        ...
        :return: The primary_api_addr of this Body108.  # noqa: E501
        :rtype: str
        """
    ...
    def primary_api_addr(self, primary_api_addr):
        """Sets the primary_api_addr of this Body108.

        The API address of the primary. If not set, the value the primary supplies in the token will be used, which is the primary's redirect address.  # noqa: E501

        :param primary_api_addr: The primary_api_addr of this Body108.  # noqa: E501
        :type: str
        """
    ...
    def token(self, token):
        """Sets the token of this Body108.

        The token given by the primary to activate secondary status for this cluster.  # noqa: E501

        :param token: The token of this Body108.  # noqa: E501
        :type: str
        """
