...
class Body44(object):
    ...
    def allowed_response_headers(self):
        """Gets the allowed_response_headers of this Body44.  # noqa: E501

        A list of headers to whitelist and allow a plugin to set on responses.  # noqa: E501

        :return: The allowed_response_headers of this Body44.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed_response_headers(self, allowed_response_headers):
        """Sets the allowed_response_headers of this Body44.

        A list of headers to whitelist and allow a plugin to set on responses.  # noqa: E501

        :param allowed_response_headers: The allowed_response_headers of this Body44.  # noqa: E501
        :type: list[str]
        """
    ...
    def audit_non_hmac_request_keys(self):
        """Gets the audit_non_hmac_request_keys of this Body44.  # noqa: E501

        The list of keys in the request data object that will not be HMAC'ed by audit devices.  # noqa: E501

        :return: The audit_non_hmac_request_keys of this Body44.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def audit_non_hmac_request_keys(self, audit_non_hmac_request_keys):
        """Sets the audit_non_hmac_request_keys of this Body44.

        The list of keys in the request data object that will not be HMAC'ed by audit devices.  # noqa: E501

        :param audit_non_hmac_request_keys: The audit_non_hmac_request_keys of this Body44.  # noqa: E501
        :type: list[str]
        """
    ...
    def audit_non_hmac_response_keys(self):
        """Gets the audit_non_hmac_response_keys of this Body44.  # noqa: E501

        The list of keys in the response data object that will not be HMAC'ed by audit devices.  # noqa: E501

        :return: The audit_non_hmac_response_keys of this Body44.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def audit_non_hmac_response_keys(self, audit_non_hmac_response_keys):
        """Sets the audit_non_hmac_response_keys of this Body44.

        The list of keys in the response data object that will not be HMAC'ed by audit devices.  # noqa: E501

        :param audit_non_hmac_response_keys: The audit_non_hmac_response_keys of this Body44.  # noqa: E501
        :type: list[str]
        """
    ...
    def default_lease_ttl(self):
        """Gets the default_lease_ttl of this Body44.  # noqa: E501

        The default lease TTL for this mount.  # noqa: E501

        :return: The default_lease_ttl of this Body44.  # noqa: E501
        :rtype: str
        """
    ...
    def default_lease_ttl(self, default_lease_ttl):
        """Sets the default_lease_ttl of this Body44.

        The default lease TTL for this mount.  # noqa: E501

        :param default_lease_ttl: The default_lease_ttl of this Body44.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this Body44.  # noqa: E501

        User-friendly description for this credential backend.  # noqa: E501

        :return: The description of this Body44.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this Body44.

        User-friendly description for this credential backend.  # noqa: E501

        :param description: The description of this Body44.  # noqa: E501
        :type: str
        """
    ...
    def listing_visibility(self, listing_visibility):
        """Sets the listing_visibility of this Body44.

        Determines the visibility of the mount in the UI-specific listing endpoint. Accepted value are 'unauth' and ''.  # noqa: E501

        :param listing_visibility: The listing_visibility of this Body44.  # noqa: E501
        :type: str
        """
    ...
    def max_lease_ttl(self):
        """Gets the max_lease_ttl of this Body44.  # noqa: E501

        The max lease TTL for this mount.  # noqa: E501

        :return: The max_lease_ttl of this Body44.  # noqa: E501
        :rtype: str
        """
    ...
    def max_lease_ttl(self, max_lease_ttl):
        """Sets the max_lease_ttl of this Body44.

        The max lease TTL for this mount.  # noqa: E501

        :param max_lease_ttl: The max_lease_ttl of this Body44.  # noqa: E501
        :type: str
        """
    ...
    def options(self, options):
        """Sets the options of this Body44.

        The options to pass into the backend. Should be a json object with string keys and values.  # noqa: E501

        :param options: The options of this Body44.  # noqa: E501
        :type: object
        """
    ...
    def passthrough_request_headers(self):
        """Gets the passthrough_request_headers of this Body44.  # noqa: E501

        A list of headers to whitelist and pass from the request to the plugin.  # noqa: E501

        :return: The passthrough_request_headers of this Body44.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def passthrough_request_headers(self, passthrough_request_headers):
        """Sets the passthrough_request_headers of this Body44.

        A list of headers to whitelist and pass from the request to the plugin.  # noqa: E501

        :param passthrough_request_headers: The passthrough_request_headers of this Body44.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def token_type(self):
        """Gets the token_type of this Body44.  # noqa: E501

        The type of token to issue (service or batch).  # noqa: E501

        :return: The token_type of this Body44.  # noqa: E501
        :rtype: str
        """
    ...
    def token_type(self, token_type):
        """Sets the token_type of this Body44.

        The type of token to issue (service or batch).  # noqa: E501

        :param token_type: The token_type of this Body44.  # noqa: E501
        :type: str
        """
